...
using HRWorkForceSystemBackend.Data; // Assuming this is your DbContext's namespace
using HRWorkForceSystemBackend.Models.ProjectModels; // Assuming this is your Models' namespace
using System.ComponentModel.DataAnnotations;
using Microsoft.Data.SqlClient;
using Microsoft.Extensions.Logging;
using HRWorkForceSystemBackend.DTOs.ProjectDTOs;
...
namespace HRWorkForceSystemBackend.Controllers
{
    ...
    [ApiController]
    public class ProjectAssignmentsController(AppDbContext context, ILogger<ProjectAssignmentsController> logger) : ControllerBase
    {
        // 2. Assign them directly to your private fields
        private readonly AppDbContext _context = context;
        private readonly ILogger<ProjectAssignmentsController> _logger = logger;
        ...
        public async Task<IActionResult> GetProjectAssignments()
        {
            ...
            {
                // Log the excep
                    _logger.LogError(ex, "An unexpected error occurred while retrieving assignments.");
        ...
        public async Task<IActionResult> GetProjectAssignmentById(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "An unexpected error occurred while retrieving the assignment.");
